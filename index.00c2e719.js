...
})({"8DKRH":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "f9c5f4b800c2e719";
...
},{}],"89eDg":[function(require,module,exports) {
...
galeryRef.insertAdjacentHTML("beforeend", renderGalery((0, _appJsDefault.default)));
...
function onLeftSliderClick() {
    let imagesArray = (0, _appJsDefault.default).map((item)=>item.original);
    modalImgRef.src = imagesArray[imagesArray.indexOf(modalImgRef.src) - 1];
    if (imagesArray.indexOf(modalImgRef.src) === -1) modalImgRef.src = imagesArray[imagesArray.length - 1];
}
function onRightSliderClick() {
    let imagesArray = (0, _appJsDefault.default).map((item)=>item.original);
    modalImgRef.src = imagesArray[imagesArray.indexOf(modalImgRef.src) + 1];
    if (imagesArray.indexOf(modalImgRef.src) === -1) modalImgRef.src = imagesArray[0];
}
function onRightArrowKeyPress(event) {
    if (event.code === "ArrowRight") onRightSliderClick();
}
function onLeftArrowKeyPress(event) {
    if (event.code === "ArrowLeft") onLeftSliderClick();
}
console.log("lorem");

},{"./app.js":"jBWKs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jBWKs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["8DKRH","89eDg"], "89eDg", "parcelRequire94c2")

//# sourceMappingURL=index.00c2e719.js.map
